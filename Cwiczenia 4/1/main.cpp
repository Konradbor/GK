...
*/
#include​ <GL/glut.h>
#include​ <GL/glext.h>#ifndef​ WIN32
...
GLint​ texture_compression_hint =​ GL_DONT_CARE​ ;// funkcja rysująca napis w wybranym miejscu
...
glVertex2f(1.5, -1.5);
glEnd();
// wyłączenie teksturowania dwuwymiarowegoglDisable(​ GL_TEXTURE_2D​ );
...
case​ GL_RED​ :
sprintf(string,​ "GL_TEXTURE_INTERNAL_FORMAT
break​ ;
case​ GL_GREEN​ :
sprintf(string,​ "GL_TEXTURE_INTERNAL_FORMAT
break​ ;
...
// formaty rozszerzenia 3DFX_texture_compression_FXT1
case​ GL_COMPRESSED_RGB_FXT1_3DFX​ :
sprintf(string,​ "GL_COMPRESSED_RGB_FXT1_3DFX"​ );break​ ;
case​ GL_COMPRESSED_RGBA_FXT1_3DFX​ :
...
{
// zmienne użyte przy obsłudze plików TARGAGLsizei​ width, height;
GLenum​ format, type;
GLvoid​ *pixels;
...
pixels);
// utworzenie identyfikatora tekstury
glGenTextures(1, &LENA_GRAY_UNC);// dowiązanie stanu tekstury
...
// utworzenie podmenu - Aspekt obrazuint​ MenuAspect =​ glutCreateMenu​ (Menu);
#ifdef​ WIN32
#else
